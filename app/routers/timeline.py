...
@router.post("/api/timeline/{book_id}/create-timeline-card", status_code=200)
...
@router.get("/api/timeline/{book_id}/get-timeline-cards", status_code=200)
...
@router.get("/api/timeline/{book_id}/latest-timeline-index", status_code=200)
